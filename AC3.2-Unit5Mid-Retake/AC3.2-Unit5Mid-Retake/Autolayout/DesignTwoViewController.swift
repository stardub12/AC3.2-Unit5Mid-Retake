...
class DesignTwoViewController: UIViewController, CellTitled {
  ...
  let pokeballGray = UIColor(red: 155.0/255.0, green: 155.0/255.0, blue: 155.0/255.0, alpha: 1.0)
  ...
  internal lazy var pokeballBackgroundView: UIView = {
    let view: UIView = UIView()
    view.backgroundColor = self.pokeballGray
    return view
  }()
